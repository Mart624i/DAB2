...
namespace dab2_EfCore.Controllers
{
    ...
    public class MunicipalitiesController : ControllerBase
    {
        ...
        public async Task<ActionResult<Municipality>> PostMunicipality(Municipality municipality)
        {
            ...
            return CreatedAtAction("GetMunicipality", new { id = municipality.Zipcode }, municipality);
        }
        ...
        {
            return _context.Municipalities.Any(e => e.Zipcode == id);
        }
    }
}
